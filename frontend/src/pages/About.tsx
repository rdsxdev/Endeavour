...
const HIGH_RES_ABOUT =
  "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?q=80&w=2600&auto=format&fit=crop"
  ...
  return (
    <div className="bg-ink pb-24">
      <section className="relative h-[420px] overflow-hidden">
        <img src={HIGH_RES_ABOUT} alt="" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="absolute inset-x-0 bottom-0 z-10">
          <div className="mx-auto max-w-7xl px-5 pb-14 lg:px-8">
            <Reveal>
              <p className="eyebrow text-emerald-bright">The Endeavour protocol</p>
              ...
              <p className="mt-5 max-w-2xl text-lg text-ink/70">
                We built Endeavour to solve opacity, double-counting, and slow settlement
                in carbon markets — extending the same rails to biodiversity and sovereign green bonds.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
          ...
          <div className="grid gap-px bg-line md:grid-cols-3">
            {PILLARS.map((p, i) => (
              <article key={p.title} className="bg-ink p-8 md:p-10">
                <span className="font-mono text-sm text-emerald-deep">{String(i + 1).padStart(2, "0")}</span>
                <h3 className="font-serif mt-4 text-xl text-paper">{p.title}</h3>
        ...
        <section id="technology" className="mt-20">
          <Reveal>
            ...
            <h2 className="font-serif mt-2 text-3xl text-paper">Three pools, one registry</h2>
            <p className="mt-3 max-w-2xl text-mute">
              CarbonPool, BioPool, and Green Bond Vault share settlement infrastructure
              while maintaining distinct asset-class governance.
            </p>
          </Reveal>
        ...
        <section id="how" className="mt-20 border-t border-line pt-16">
          <Reveal>
            <h2 className="font-serif text-center text-3xl text-paper">Built for institutional standards</h2>
            <p className="mx-auto mt-3 max-w-xl text-center text-mute">
              Operating at the intersection of climate science and cryptographic security.
            </p>
          </Reveal>
        ...
        <Reveal className="mt-20">
          <div className="border border-line bg-ink-2 p-10 text-center sm:p-14" id="contact">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-mute">
              Whether you&apos;re an institutional buyer sourcing verified credits or a sovereign
              issuer listing green bonds, Endeavour provides the settlement layer.
            </p>
