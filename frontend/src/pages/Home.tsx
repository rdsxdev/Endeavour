...
import { formatCompact, formatNumber } from "../api"
...
import heroRenewable from "../assets/hero-renewable.png"
...
function Featured() {
  ...
  const ref = useReveal<HTMLDivElement>()
  const featured = credits.filter((c) => c.verified && !c.retired).slice(0, 3)
